...
public class doctorpanel extends JFrame {
	...
	public doctorpanel() {
		...
		JLabel lblDoctorPannel = new JLabel("Doctor Panel");
		...
		btnAddDoctor.setIcon(new ImageIcon("D:\\My Softwares\\Eclipse\\Icon and images for project\\add new patient.png"));
